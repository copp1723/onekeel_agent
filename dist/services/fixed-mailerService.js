...
export async function initializeMailer(apiKey, options = {}) {
    ...
    if (options.defaultFrom)
        mailerConfig.defaultFrom = options.defaultFrom;
    if (options.defaultFromName)
        mailerConfig.defaultFromName = options.defaultFromName;
...
//# sourceMappingURL=fixed-mailerService.js.map