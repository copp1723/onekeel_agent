 ...
 */
export const stepHandlers: Record<WorkflowStepType, StepHandler> = {
 ...
 */
function processFilter(data: any, config: Record<string, any>) {
  // Implementation would depend on the specific filtering needs
  return data;
}

function processTransform(data: any, config: Record<string, any>) {
  // Implementation would depend on the specific transformation needs
  return data;
}

function processAggregate(data: any, config: Record<string, any>) {
